...
# Version of the function above that accounts for multi species

# bin capt should now be in the following format: (?)
...
fit_scr_multi <- function(bin_capt, mask_coords, mask_df, traps, formula, detfn = "HN", sigma_upper_limit = NULL) {
  # Load functions
  source("misc functions/avg_trap_dist.R")
  source("get_params.R")
  source("scr_log_likelihood.R")
  ...
  # Get starting params and design matrix
  # TO DO find out if need to consolidate into single design matrix
